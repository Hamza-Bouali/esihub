  ...
  const features = [
    {
      ...
      description: 'Share your resources and ideas with the community',
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
        ...
        <div className="container mx-auto px-4 py-24">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Help us improve ESIHUB by sharing your resources and ideas.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-800 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Why Contribute?</h2>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">Join our community and make a difference today.</p>
